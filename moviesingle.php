...
<head>
    ...
    <script>
        ...
        $.getJSON(base_uri + "/movie/" + v + "?api_key=" + api_key + "&callback=?",
            function(json) {
                ...
                $('#length').html(json.runtime);
                $('#premiere').html(json.release_date);
                $('#genre').html(json.genres[0].name);
                $('#genre1').html("/" + json.genres[1].name);
                $('#genre2').html("/" + json.genres[2].name);
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <ul class="movie-meta">
                                    ...
                                    <li><strong>Length: </strong><strong id="length"></strong>mins</li>
                                    <li><strong>Premiere:</strong> <strong id="premiere"></strong></li>
                                    <li><strong>Category:</strong><strong id="genre"></strong><strong id="genre1"></strong><strong id="genre2"></strong></li>
                                </ul>
